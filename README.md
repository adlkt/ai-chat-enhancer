...
A browser extension that enhances the ChatGPT and DeepSeek web chat experience. Currently features a **conversation outline sidebar** for ChatGPT — navigate long threads by jumping between user messages with a single click.
